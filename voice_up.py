...
def logmmse(x, Srate, noise_frames=6, Slen=0, eta=0.15, saved_params=None):
    ...
    for k in range(0, Nframes * len2, len2):
        ...
        if Xk_prev.all() == 0:
            ...
            ksi = aa * Xk_prev / noise_mu2 + \
                (1 - aa) * np.maximum(gammak - 1, 0)
...
filename = '/Users/jeremywang/Desktop/ikala_kpop/dataset-eval-kpop-3407895655_2-vocal.wav'
